...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Stroke Care — Intelligent Rehabilitation Assistant" },
      { name: "description", content: "Personalized daily stroke rehabilitation with an AI coach, exercise plans, progress tracking, and medication reminders." },
      { property: "og:title", content: "Stroke Care — Intelligent Rehabilitation Assistant" },
      ...
      { name: "twitter:title", content: "Stroke Care — Intelligent Rehabilitation Assistant" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700&family=Instrument+Serif&display=swap" },
